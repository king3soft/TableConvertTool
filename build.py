...
def build_package(ctx):
    ...
    shutil.copytree("ext", os.path.join(nsis_dir, "ext"), ignore = shutil.ignore_patterns("__pycache__"))
    shutil.copytree("docs", os.path.join(nsis_dir, "docs"), ignore = shutil.ignore_patterns("__pycache__"))
